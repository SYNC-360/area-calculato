...
export const metadata: Metadata = {
  ...
  description: "Area of circle calculator using formulas A = πr², A = πd²/4, and A = C²/4π. Calculate area of a circle instantly from radius, diameter, or circumference with step-by-step solutions.",
  keywords: "area of circle, area of circle calculator, area of circle formula, how to find area of circle, how to calculate area of circle, circle area, πr², πr squared, area of a circle, circle area calculator",
  ...
  openGraph: {
    ...
    description: "Calculate area of circle instantly using radius, diameter, or circumference. Free area of circle calculator with step-by-step solutions and visual examples.",
  ...
  twitter: {
    ...
    description: "Calculate area of circle from radius, diameter, or circumference. Free online calculator with formulas and examples.",
    images: ["https://areaofcircle.com/og-image.jpg"],
  },
  alternates: {
    canonical: "https://areaofcircle.com",
  },
  robots: {
    index: true,
    follow: true,
              ...
              "@graph": [
                {
                  ...
                  "url": "https://areaofcircle.com",
                  "description": "Free online calculator to find the area of a circle using radius, diameter, or circumference",
